...
import { IconeFechar, IconeMenu, IconeWhatsApp } from './icons'
    ...
    <>
      ...
      >
        <nav
          ...
          className="pointer-events-auto relative flex w-full max-w-[1120px] items-center justify-between gap-2 rounded-full border border-white/[0.08] bg-[rgba(10,11,13,0.9)] py-2 pl-5 pr-2 shadow-[0_18px_50px_-20px_rgba(0,0,0,0.7)] lg:w-auto lg:bg-[rgba(10,11,13,0.62)] lg:backdrop-blur-xl lg:backdrop-saturate-150"
        >
          <a
            href="#inicio"
            onClick={(e) => {
