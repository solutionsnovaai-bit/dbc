      ...
      <div className="sticky top-0 flex h-[100svh] flex-col justify-center pt-16">
        <Conteiner>
          ...
          <div className="relative mt-[clamp(2.25rem,6vh,4.5rem)]">
            ...
            <motion.div aria-hidden="true" className="absolute inset-x-0 top-[7px] h-px origin-left bg-branco" style={{ scaleX: linha }} />
    ...
    <div className="pb-36 pt-28 lg:hidden">
      <Conteiner>
        ...
        <ol ref={lista} className="relative mt-14">
          ...
          <motion.span
            aria-hidden="true"
            className="absolute bottom-6 left-[7px] top-2 w-px origin-top bg-branco"
